...
2. **Top risks** — highest initial-risk threats (likelihood x impact), each with a one-line
   plain-language description and current `status`.
3. **Treatment status** — how many threats are mitigated / accepted / open, and residual risk
   picture in one or two sentences (not a full table).
