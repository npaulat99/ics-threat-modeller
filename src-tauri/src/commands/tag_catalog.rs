...
pub fn seed_tag_catalog(conn: &rusqlite::Connection) -> Result<(), String> {
    ...
    let assets = vec![
        ...
        ("SCADA Server", "Supervisory Control and Data Acquisition server"),
        ("DCS Controller", "Distributed Control System controller"),
        ("Engineering Workstation", "Used for programming and configuring controllers"),
    ...
    let interfaces = vec![
        ...
        ("OPC DA/HDA", "OPC Classic (Data Access / Historical Data Access)"),
    ...
    let third_party = vec![
        ...
        ("Siemens TIA Portal", "Siemens Totally Integrated Automation"),
